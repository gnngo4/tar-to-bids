...
class mprage:
    ...
    def get_info(self):
        ...
        mprage = create_key('sub-{subject}/{session}/anat/sub-{subject}_{session}_acq-MPRAGE_run-{item:02d}_T1w')
        ...
        for s in self.seqinfo:
            ...
            if 'T1_3D' in s.series_description: info[mprage].append({'item': s.series_id})
