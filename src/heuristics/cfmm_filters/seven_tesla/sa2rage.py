...
class sa2rage:
    ...
    def get_info(self):
        ...
        b1map = create_key('sub-{subject}/{session}/fmap/sub-{subject}_{session}_acq-b1map_run-{item:02d}_part-mag_TB1SRGE')
        inv1 = create_key('sub-{subject}/{session}/fmap/sub-{subject}_{session}_inv-1_run-{item:02d}_part-mag_TB1SRGE')
        inv2 = create_key('sub-{subject}/{session}/fmap/sub-{subject}_{session}_inv-2_run-{item:02d}_part-mag_TB1SRGE')
