...
def infotodict(seqinfo):
    ...
    from src.heuristics.cfmm_filters.three_tesla.gre_field_map import gre_field_map
    from src.heuristics.cfmm_filters.three_tesla.schmitz_osc_3t_v1 import bold
