...
def pair_physio_to_mri(tar_tree: str, subject_id: str, session_id: str, bids_dir: str) -> None:
    """
...
def _get_physio_pairs(tar_tree: str):
    ...
    assert tar_tree is not None, f"Initialize tar_tree with the reformat_dicom_tree() method."
...
def _pair_physio_to_mri(tar_tree: str, physio_pairs: dict, subject_id: str, session_id: str, bids_dir: str) -> None:
    '''
